...
def meanShift(features):  #features is [[float]]
    ...
    bandwidth = estimate_bandwidth(features_pca, quantile=0.05,
                                    n_samples=None)
...
file_in = "datasets/opt_flatness_loudness_centroid_mfcc.csv"
folder_in = "segments/opt_segments/"
folder_out = "audio/clusters_opt_nada/"
...
#%%
csv_fileOut = "opt_flatness_loudness_centroid_mfcc_classes.csv"
labels = b.tolist()
